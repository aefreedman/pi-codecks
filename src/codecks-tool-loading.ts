...
export const CODECKS_SEARCH_CATALOG: readonly CodecksSearchCatalogEntry[] = [
  ...
  { name: "codecks_card_bulk_create", aliases: ["bulk create cards", "import cards", "csv card import"], tags: ["card", "bulk", "create", "import", "mutation", "preview"], guidance: ["Run with dryRun=true first, review duplicate candidates, and apply only after explicit approval."], activeSafety: `${MUTATION_OPERATION_SAFETY} Default to dryRun=true and apply only after approval of the preview and duplicate review.` },
  { name: "codecks_card_bulk_update", aliases: ["bulk update cards", "import card updates", "csv card update"], tags: ["card", "bulk", "update", "import", "mutation", "preview"], guidance: ["Run with dryRun=true first and apply broad tracker edits only after explicit approval of the preview."], activeSafety: `${MUTATION_OPERATION_SAFETY} Default to dryRun=true and apply only after approval of the preview.` },
